...
import { CreateOwner, OwnerDisplay, OwnerProfile } from '../models/owner';
...
export class ClientService {
  ...
  getClientById(id: number): Observable<OwnerProfile>{
    return this.http.get<OwnerProfile>(`${this.apiUrl}/${id}`)
  }
